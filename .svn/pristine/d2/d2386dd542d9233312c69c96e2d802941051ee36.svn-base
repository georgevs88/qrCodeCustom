...
public class Ambrel extends WindowCrud{
	...
	public void imprimir() throws InterruptedException {
		...
		param.put("entamb", datini!=null?sdf.format(datini):"-");
		param.put("entambfim", datfim!=null?sdf.format(datfim):"-");
		new WinUtils().abrirBirt("ambrel.rptdesign", param);
	}
