...
public class Rlirel extends WindowCrud{
	...
	public void imprimir() throws InterruptedException {
		...
		//	new WinUtils().abrirBirt("rlirel2.rptdesign", param);
		//} else {
		if(formato.equals("PDF"))
			new WinUtils().abrirBirt("rlirel.rptdesign", param);
		else if (formato.equals("HTML")) {
			new WinUtils().abrirBirt("rlirelDiogrande.rptdesign", param);
			//new WinUtils().abrirBirt(getCodSis(), null, null, null, "HTML", null, "rlirelDiogrande.rptdesign", param);
		}
		//}
	}
