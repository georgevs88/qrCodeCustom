...
public class Lmalis extends WindowList<HashMap<String,Object>>{

	private static final long serialVersionUID = 1L;
	public List<LmaVO> lista;
	public LmaVO lma = new LmaVO();
	...
	public void pesquisar() {
		...
		try {
			pag.setTotalSize(new LmaDAO().getCountByCriterio(lma));
	...
	private void redraw(LmaVO obj, Integer inicial, Integer maximoPermitido) {
		this.lista = new LmaDAO().getByCriterioLimit(obj, inicial, maximoPermitido);
	}
