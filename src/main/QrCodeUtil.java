...
public class QrCodeUtil {
    ...
    private final static String DIR = "C:\\tools\\qrcode";
    private final static String ext = ".png";
    private final static String LOGO = "http://intranet.defensoria.ms.gov.br/portal/resources/img/logoDPGESemNome.png";
    private final static String CONTENT = "http://www.defensoria.ms.gov.br/";
    ...
    private static MatrixToImageConfig getMatrixConfig() {
        // ARGB Colors
        // Check Colors ENUM
        return new MatrixToImageConfig(Colors.GREEN.getArgb(), Colors.BEGE.getArgb());
    }
