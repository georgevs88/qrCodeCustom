...
public class ViaVO {
	...
	private String crevia; //Confirmação Recebimento, S=SIM, N=NAO
	...
	private String einvia; //empreendedor individual DO=Domicílio,SP=Sede Permanente,CL=No Cliente,CP=Vias Públicas,SP=Vias Públicas, sem ponto fixo
	private String evevia; //evento
	private String cprvia; //CPF/CNPJ Responsável
	private String norvia; //Nome/Razão Social Responsável
	private String ddtvia; //DDD Tel Responsável
	private String telvia; //Telefone Responsável
	private String emavia; //email Responsável
